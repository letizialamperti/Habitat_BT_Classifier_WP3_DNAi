...
EMBEDDINGS_FILE="/scratch/snx3000/llampert/embedding_coords/new_embedding_coordinates_dataset_corse_342__.csv"
PROTECTION_FILE="label/labels_corse_protection_5.csv"
HABITAT_FILE="habitat/habitat_corse.csv"
